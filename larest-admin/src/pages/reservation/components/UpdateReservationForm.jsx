import { actionResetData, actionUpdate, useCrudContext } from "@/context/CrudContextProvider";
...
function UpdateReservationForm({ open, onClose }) {
  ...
  return (
    <Drawer open={open} onClose={handleOnClose} anchor="right" sx={{ filter: "blur(0)" }}>
      <Box role="presentation" sx={{ padding: "1rem" }}>
        ...
        <form onSubmit={(e) => handleSubmit(e)} className="mt-3 flex flex-col gap-2">
          ...
          <Typography level="title-sm" className="mt-3">
          ...
          <Textarea
            ...
            name="notes"
          />
          <Typography level="title-sm" className="">
            Restaurant Plan
          </Typography>
