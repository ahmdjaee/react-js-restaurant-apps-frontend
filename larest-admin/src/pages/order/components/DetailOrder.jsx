    ...
    <>
      ...
      >
        ...
        <div className="flex-1 flex-col flex items-start gap-3">
          ...
          <div className="flex items-center border-b border-gray-300 pb-2 w-full">
            ...
            <Chip variant="soft" color="primary" className="w-full md:w-auto">
              {order.status}
            </Chip>
          </div>
          <div className="flex items-center w-full border-b border-gray-300 pb-2">
          ...
          <div className="flex items-center w-full border-b border-gray-300 pb-2">
            ...
            <Chip variant="soft" color="success" className="w-full md:w-auto">
              {order.reservation.status}
            </Chip>
          </div>
          <div className="flex items-center w-full border-b border-gray-300 pb-2">
            <p className="w-64 font-semibold text-gray-700">Notes</p>
      ...
      <CustomMainCard header={"Order Items"}>
        {order.items.map((item) => (
          <div
            key={item.id}
            className="mb-3 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6 "
          >
