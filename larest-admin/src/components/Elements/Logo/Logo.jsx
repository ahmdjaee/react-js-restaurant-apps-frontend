    ...
    <Link to={home} className=" flex items-center gap-5 ">
      ...
      >
        <path
          ...
          stroke="url(#paint0_linear_186_4)"
          strokeWidth="3.57143"
        />
        <path
          d="M0.00261579 31C0.000871931 31.1188 0 31.2378 0 31.3571C0 44.5725 10.7132 55.2857 23.9286 55.2857C37.1439 55.2857 47.8571 44.5725 47.8571 31.3571C47.8571 31.2378 47.8563 31.1188 47.8545 31H0.00261579Z"
          fill="url(#paint1_linear_186_4)"
        />
        <path
      ...
      <p className="text-2xl font-bold text-gray-800 mt-2">larest</p>
    </Link>
  );
}
