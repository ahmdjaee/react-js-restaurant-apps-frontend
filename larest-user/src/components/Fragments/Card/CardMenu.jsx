  ...
  return (
    <Link to={link} className={className}>
      <div className="bg-white rounded flex flex-col items-center shadow text-start cursor-pointer transition ease-in-out delay-0 hover:-translate-y-1 hover:scale-105">
        <img className="object-cover rounded-t object-center size-[200px] sm:h-[250px] w-full" src={image ? image : "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTJRS-4chjWMRAmrtz7ivK53K_uygrgjzw9Uw&s"} alt="" />
