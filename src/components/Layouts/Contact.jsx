        ...
        <div class="container">
            <div class="mb-4">
                <div class="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                    <p class="text-base font-semibold uppercase tracking-wide mb-3 text-primary dark:text-blue-200">
                        Contact
                    </p>
                    <h2
                    ...
                    <div class="card h-fit max-w-6xl p-5 md:p-12" id="form">
                        ...
                        <form id="contactForm">
                            ...
                            <div class="text-center">
                                <button type="submit" class="w-full bg-dark text-white px-6 py-3 font-xl rounded-md sm:mb-0">Send Message</button>
                            </div>
                        </form>
                    </div>
                </div>
